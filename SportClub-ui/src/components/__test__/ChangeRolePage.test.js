...
describe('Testing role', () => {
 ...
 var CryptoJS=require("crypto-js");
   ...
   it('renders without crashing', async () => {
        ...
        render(
            <BrowserRouter>
                <ChangeRole err={false} required={true} location={{hash:"",pathname:"/appUsers/1",search:"",state:undefined }} match={{params: {id: 1}, isExact: true, path: "/appUsers/:id", url: "/appUsers/1"}}/>
            </BrowserRouter>,root
        );
